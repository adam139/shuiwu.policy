#-*- coding: UTF-8  -*-
import unittest
from shuiwu.policy.testing import INTEGRATION_TESTING
...
class TestSetup(unittest.TestCase):
    ...
    def test_portal_title(self):
        ...
        self.assertEqual("湘潭税务管理信息", portal.getProperty('title'))
    ...
    def test_Requirements_installed(self):
        ...
        self.assertTrue('shuiwu.baoshui.nashuiren' in portal_types)
