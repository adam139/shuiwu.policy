...
from shuiwu.policy.browser.interfaces import IXtshzzThemeSpecific as IThemeSpecific
import datetime
...
class MembraneMemberView(grok.View):
    ...
    def getSponsorOrgName(self):
        ...
        from shuiwu.policy.behaviors.org import ISponsor
        id = self.currentUserEmail()
        if id =="":return False
...
# is sponsor :government department        
    ...
    def SurveyUrl(self):
        ...
        from shuiwu.policy.behaviors.org import IOrg
